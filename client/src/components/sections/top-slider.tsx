...
export default function TopSlider() {
  ...
  return (
    <section className="relative w-full h-[485px] lg:h-[585px] overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-900 dark:to-gray-800 mt-4">
      <div 

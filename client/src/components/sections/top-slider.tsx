            ...
            <div className="relative z-10 h-full flex items-center">
              <div className="container mx-auto px-4 lg:px-8">
                <div className="max-w-3xl text-white">
                  <h1 className="text-4xl lg:text-6xl font-bold mb-6 leading-tight" data-testid={`slide-title-${index}`}>
                    {slide.title}
                  </h1>
                  <p className="text-xl lg:text-2xl mb-8 opacity-90" data-testid={`slide-subtitle-${index}`}>
                    {slide.subtitle}
                  </p>

    ...
    <Card className="group hover:shadow-lg transition-all duration-300 cursor-pointer border border-gray-200 dark:border-gray-700 hover:border-primary/30 bg-white dark:bg-gray-800 rounded-lg overflow-hidden hover:-translate-y-1" onClick={(e) => {
      ...
      <CardContent className="p-4">
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4 lg:gap-6">
          {/* Top/Left Section - Logo and Basic Info */}
          <div className="flex items-start gap-4 flex-1">
            <div className="relative flex-shrink-0">
              <img 
                src={logo} 
                alt={`${hostel.hostel_name} logo`}
                className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl object-cover border-2 border-gray-200 dark:border-gray-600 group-hover:scale-105 transition-transform duration-200 shadow-md"
              />
            ...
            <div className="flex-1 min-w-0">
              <div className="mb-3">
                <h3 className="font-bold text-xl sm:text-2xl text-gray-900 dark:text-white group-hover:text-primary transition-colors mb-1">
                  {hostel.hostel_name}
                </h3>
                ...
                <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 mb-2">
                  ...
                  <span className="font-medium truncate">{hostel.location}, {cityName}, {provinceName}</span>
                </div>
              </div>
          ...
          <div className="flex flex-col gap-3 w-full lg:w-auto lg:min-w-[200px] lg:max-w-[250px]">
            ...
            <Button 
              size="lg"
              className="w-full group-hover:bg-primary group-hover:text-white bg-primary/10 text-primary hover:bg-primary hover:text-white border-primary/20 hover:border-primary transition-all duration-200 px-4 sm:px-8 py-3 text-sm sm:text-base font-semibold shadow-md hover:shadow-lg"
            ...
            <div className="flex gap-2 w-full">
              <div className="flex-1">
                <Button 
                  size="sm"
                  variant="outline"
                  className="w-full border-blue-200 text-blue-600 hover:bg-blue-50 hover:text-blue-700 hover:border-blue-300 transition-all duration-200 py-2 text-xs sm:text-sm font-medium shadow-sm"
                  onClick={(e) => {
                    e.stopPropagation();
              ...
              <div className="flex-1">
                <Button 
                  size="sm"
                  variant="outline"
                  className="w-full border-green-200 text-green-600 hover:bg-green-50 hover:text-green-700 hover:border-green-300 transition-all duration-200 py-2 text-xs sm:text-sm font-medium shadow-sm"
                  onClick={(e) => {
                    e.stopPropagation();
            ...
            {/* Contact Information - Under Action Buttons */}

            ...
            <div className="grid grid-cols-2 gap-2 mb-3">
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-2 border border-blue-100 dark:border-blue-800">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium text-gray-900 dark:text-white truncate">{hostel.mobile}</span>
                </div>
              </div>
              ...
              <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-2 border border-green-100 dark:border-green-800">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium text-gray-900 dark:text-white truncate">{hostel.whatsapp}</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                <Button 
                  size="sm"
                  variant="outline"
                  className="text-xs border-blue-200 text-blue-600 hover:bg-blue-50 hover:border-blue-300 py-1.5"
                  onClick={(e) => {
                    e.stopPropagation();
                ...
                <Button 
                  size="sm"
                  variant="outline"
                  className="text-xs border-green-200 text-green-600 hover:bg-green-50 hover:border-green-300 py-1.5"
                  onClick={(e) => {
                    e.stopPropagation();
